...
var storyContent = ﻿{"inkVersion":16,"root":["^You wonder, what is your place in this story","\n",{"->":"paragraph_1"},"done",{"paragraph_1":["^You stand by the wall of Analand, sword in hand.","\n",["ev","str","^Open the gate","/str","/ev",{"*":".^.c","flg":4},{"c":[{"->":"paragraph_2"},{"#f":7}]}],["ev","str","^Smash down the gate","/str","/ev",{"*":".^.c","flg":4},{"c":[{"->":"paragraph_3"},{"#f":7}]}],["ev",{"^->":"paragraph_1.4.$r1"},{"temp=":"$r"},"str",{"->":".^.s"},[{"#n":"$r1"}],"/str","/ev",{"*":".^.c","flg":18},{"s":["^Recall your mission",{"->":"$r","var":true},null],"c":["ev",{"^->":"paragraph_1.4.c.$r2"},"/ev",{"temp=":"$r"},{"->":".^.^.s"},[{"#n":"$r2"}],"\n","^Oh yes, that seems important, knowing what to do. Not as important as getting through the damn gate for medical attention though. Well done, boy scout.","\n","done",{"#f":7}]}],{"#f":3}],"paragraph_2":["^You open the gate, and step out onto the path. ",{"->":"safety_first"},"\n","done",{"#f":3}],"paragraph_3":["^You Smash down the gate, and shit you're falling.","\n",["ev","str","^Grab on to something","/str","/ev",{"*":".^.c","flg":20},{"c":["^There is nothing to grab onto, fool.","\n","done",{"#f":7}]}],["ev","str","^Scream","/str","/ev",{"*":".^.c","flg":20},{"c":["^In space no one can hear you scream.","\n","done",{"#f":7}]}],{"#f":3}],"safety_first":["^Everything makes little sense so far","\n",["ev","str","^Scan the environment","/str","/ev",{"*":".^.c","flg":4},{"c":[{"->":"Bird_watching"},{"#f":7}]}],["ev","str","^Walk freely","/str","/ev",{"*":".^.c","flg":4},{"c":["^A gun shot out in the distance, you're most certain it got you right in the neck.","\n","done",{"#f":7}]}],{"#f":3}],"Bird_watching":["^You observe a little bird walking a little funny, \"Birds should be flying anyway, not walking\" You thought","\n",["ev",{"^->":"Bird_watching.2.$r1"},{"temp=":"$r"},"str",{"->":".^.s"},[{"#n":"$r1"}],"/str","/ev",{"*":".^.c","flg":18},{"s":["^Approach Bird",{"->":"$r","var":true},null],"c":["ev",{"^->":"Bird_watching.2.c.$r2"},"/ev",{"temp=":"$r"},{"->":".^.^.s"},[{"#n":"$r2"}],"\n","^\"This wasn't worth it\" You thought to yourself as you held the wound in your chest. Medical attention was more important than discovering why some birds walked and some birds flew.","\n","done",{"#f":7}]}],["ev",{"^->":"Bird_watching.3.$r1"},{"temp=":"$r"},"str",{"->":".^.s"},[{"#n":"$r1"}],"/str","/ev",{"*":".^.c","flg":18},{"s":["^Walk freely",{"->":"$r","var":true},null],"c":["ev",{"^->":"Bird_watching.3.c.$r2"},"/ev",{"temp=":"$r"},{"->":".^.^.s"},[{"#n":"$r2"}],"\n","^A gun shot out in the distance, you're most certain it got you right in the neck.","\n","done",{"#f":7}]}],["ev","str","^Throw sword at Bird","/str","/ev",{"*":".^.c","flg":20},{"c":["^You struck down the bird. Kablam. It wasn't really a bird, it was an ihur. \"Them again...\" you thought as you walked over to pick up your sword.","\n",{"->":"bombs_away"},{"#f":7}]}],{"#f":3}],"bombs_away":["^In the distance you see the sky filled with spears heading your way, like you saw in 300. You knew this was because of what you did. You don't regret. Today is as good as any other to die in a pit of goodums.","\n",["ev",{"^->":"bombs_away.2.$r1"},{"temp=":"$r"},"str",{"->":".^.s"},[{"#n":"$r1"}],"/str","/ev",{"*":".^.c","flg":18},{"s":["^BY THE POWER OF GRAY SKULL!",{"->":"$r","var":true},null],"c":["ev",{"^->":"bombs_away.2.c.$r2"},"/ev",{"temp=":"$r"},{"->":".^.^.s"},[{"#n":"$r2"}],"\n","^You yell at the top of your voice, this does feel pretty good you thought to yourself. Both the battle cry that meant nothing, and your sweet passing from this vile planet. You wish you could go back to the start","\n",{"->":"Time_travel"},{"#f":7}]}],{"#f":3}],"Time_travel":[["ev",{"^->":"Time_travel.0.$r1"},{"temp=":"$r"},"str",{"->":".^.s"},[{"#n":"$r1"}],"/str","/ev",{"*":".^.c","flg":18},{"s":["^Go back to the start",{"->":"$r","var":true},null],"c":["ev",{"^->":"Time_travel.0.c.$r2"},"/ev",{"temp=":"$r"},{"->":".^.^.s"},[{"#n":"$r2"}],"\n",{"->":"paragraph_1"},{"#f":7}]}],["ev",{"^->":"Time_travel.1.$r1"},{"temp=":"$r"},"str",{"->":".^.s"},[{"#n":"$r1"}],"/str","/ev",{"*":".^.c","flg":18},{"s":["^This game hurts my face, let me out.",{"->":"$r","var":true},null],"c":["ev",{"^->":"Time_travel.1.c.$r2"},"/ev",{"temp=":"$r"},{"->":".^.^.s"},[{"#n":"$r2"}],"\n","^The next one will be better, I promise.","\n",{"#f":7}]}],["ev",{"^->":"Time_travel.2.$r1"},{"temp=":"$r"},"str",{"->":".^.s"},[{"#n":"$r1"}],"/str","/ev",{"*":".^.c","flg":18},{"s":["^Activate Healing Factor",{"->":"$r","var":true},null],"c":["ev",{"^->":"Time_travel.2.c.$r2"},"/ev",{"temp=":"$r"},{"->":".^.^.s"},[{"#n":"$r2"}],"\n",{"->":"Healing_Factor"},"done",{"#f":7}]}],{"#f":3}],"Healing_Factor":["^Of course. Just by eye-balling your wounds you find your body being restored by the strand. You play dead a little as you see your attackers slowly creep out.","\n",["ev","str","^Wait for them to get closer.","/str","/ev",{"*":".^.c","flg":4},{"c":[{"->":"waiting_here_for_you"},{"#f":7}]}],["ev","str","^Scream by the power of Gray Skull again.","/str","/ev",{"*":".^.c","flg":4},{"c":[{"->":"ONEMORETIME"},{"#f":7}]}],{"#f":3}],"waiting_here_for_you":["^You realise the wounds in your chest have closed, and you're pretty much patched up? Why didn't you activate your healing factor earlier? Did you forget? What else did you forget, you wonder. What did you do? Who are you?","\n","^Enemies are closer now.","\n","^Time to act.","\n",["ev","str","^Scream by the power of Gray Skull again.","/str","/ev",{"*":".^.c","flg":4},{"c":[{"->":"ONEMORETIME"},{"#f":7}]}],["ev","str","^Use Jedi-like abilities to retrieve Sword","/str","/ev",{"*":".^.c","flg":4},{"c":["^You're no Jedi. You blew your cover.","\n","^They aim.","\n","^They fire.","\n","done",{"#f":7}]}],["ev","str","^Take one as hostage","/str","/ev",{"*":".^.c","flg":4},{"c":[{"->":"Hostage_Situation"},{"#f":7}]}],{"#f":3}],"ONEMORETIME":["^\"BY THE POWER OF GRAY - !\" You find yourself lifted from the ground in the middle of your battle cry.","\n","^\"Fool.\"","\n","^Ah, the King of Analand.","\n","^With random X-men abilities no less.","\n","^You break his hold with sheer will.","\n","^You find the weakest looking henchmen and take him as your hostage.","\n",{"->":"Hostage_Situation"},{"#f":3}],"Hostage_Situation":["^You break his hold with sheer will.","\n","^You find the weakest looking henchmen and take him as your hostage.","\n","^\"Please, Grouse, it doesn't have to be like this.\"","\n","^Who was Grouse? Was that my name?","\n","^Maybe it's the name of the loser you're holding.","\n","^The King of Analand moves closer.","\n","^He waves his hand, perhaps to activate some Jedi shit.","\n","^What's it going to be?","\n",["ev","str","^Kill hostage","/str","/ev",{"*":".^.c","flg":4},{"c":["^You break his neck.","\n","^Your last gambling chip.","\n","^Not so smart.","\n","^\"YOU DIDN'T HAVE TO KILL GROUSE!\"","\n","^The King of Analand, seemed to like this chap. You could tell by the way he impaled you with his spear before tearing you up at a speed beyond your healing factor.","\n","^Ah, that's love, and that was Grouse. Sorry Grouse.","\n","done",{"#f":7}]}],["ev","str","^Attack King","/str","/ev",{"*":".^.c","flg":4},{"c":["^Attacking the King was something you were familiar with.","\n","^Wait.","\n","^You were running away from the King.","\n","^Because you attacked him earlier.","\n","^Because-","\n","^It doesn't matter right now.","\n","^He grips your throat. Again with this Vader thing.","\n",{"->":"Deeper_Battle"},{"#f":7}]}],{"#f":3}],"Deeper_Battle":[["ev",{"^->":"Deeper_Battle.0.$r1"},{"temp=":"$r"},"str",{"->":".^.s"},[{"#n":"$r1"}],"/str","/ev",{"*":".^.c","flg":18},{"s":["^IS GROUSE MY NAME?",{"->":"$r","var":true},null],"c":["ev",{"^->":"Deeper_Battle.0.c.$r2"},"/ev",{"temp=":"$r"},{"->":".^.^.s"},[{"#n":"$r2"}],"\n","^You scream out.","\n","^\"Funny you should ask, but no. Grouse is.. well, his name\"","\n","^The King pointed at the loser you were holding hostage.","\n","^Your name is well, do we really need to go there?","\n","^Your name is Mangold Analand, my son.","\n","done",{"#f":7}]}],{"#f":3}],"#f":3}],"listDefs":{}};
